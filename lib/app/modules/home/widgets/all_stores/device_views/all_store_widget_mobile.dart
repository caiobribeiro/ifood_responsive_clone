...
class AllStoresWidgetMobile extends StatefulWidget {
  final TabController tabController;
  const AllStoresWidgetMobile({
    super.key,
    required this.tabController,
  });

  @override
  State<AllStoresWidgetMobile> createState() => _AllStoresWidgetMobileState();
}

class _AllStoresWidgetMobileState extends State<AllStoresWidgetMobile> {
  @override
